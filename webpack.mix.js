...
mix
    ...
    .js('resources/js/sidebar_staff.js', 'public/js')
    .js('resources/js/file_navigator.js', 'public/js')
    .js('resources/js/search_files.js', 'public/js')
    .js('resources/js/search_locations.js', 'public/js')
    .js('resources/js/search_information.js', 'public/js')
    .js('resources/js/company_links.js', 'public/js')
