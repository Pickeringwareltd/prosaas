...
$(function () {
    ...
    var barChartExample = new Chart(BARCHARTEXMPLE, {
        ...
        data: {
            ...
            datasets: [{
                label: "Data Set 1",
                backgroundColor: [gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2],
                hoverBackgroundColor: [gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2],
                borderColor: [gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2, gradient2],
                borderWidth: 1,
    ...
    var pieChartExample = new Chart(DOUGHNUTCHARTEXMPLE, {
        ...
        data: {
            ...
            datasets: [{
                data: [250, 50, 100, 40],
                borderWidth: 0,
                backgroundColor: ['#df99ca', '#c374ab', "#a44e8a", "#81376a"],
                hoverBackgroundColor: ['#df99ca', '#c374ab', "#a44e8a", "#81376a"]
            }]
        }
    });
    ...
    var polarChartExample = new Chart(POLARCHARTEXMPLE, {
        ...
        data: {
            datasets: [{
                data: [7, 16, 12, 11],
                backgroundColor: [green, "#6adf8a", "#50c670", "#3fac5c"],
    ...
    var pieChartExample = new Chart(PIECHARTEXMPLE, {
        ...
        data: {
            ...
            datasets: [{
                data: [300, 50, 100, 80],
                borderWidth: 0,
                backgroundColor: [green, "#6adf8a", "#50c670", "#3fac5c", "#2a9346"],
                hoverBackgroundColor: [green, "#6adf8a", "#50c670", "#3fac5c", "#2a9346"]
            }]
        }
    });
...
module.exports = __webpack_require__("./resources/js/charts-custom.js");
