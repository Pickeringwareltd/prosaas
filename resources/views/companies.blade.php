        ...
        <home :user="user" inline-template id="staff_template"> 
            <div class="container-fluid">
                <div class="row companies_table p-5">
                    ...
                    <div class="col-10 col-sm-4 col-xl-3 ml-5 mr-5 mb-5 shadow company_card" id="techquity" data-link="/company">
                      <div class="row pr-3 py-4 shadow company_img">
                      ...
                      <div class="row p-3 mt-5">
                        ...
                        <div class="col-12 p-4">
                            <div class="row">
                              ...
                              <p class="w-100 pt-2"><b class="no_of_staff">THIRTY</b> people work here</p>
                            </div>
                          </div>
                        </div>
                      </div>
...
@section('javascripts')
    ...
    <script src="/js/company_links.js"></script>
@endsection